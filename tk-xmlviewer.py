...
# %s"%"61706c69636163696f6e616d656469646140676d61696c2e636f6d".decode("hex"))
...
class XML_Viwer(Frame):
	...
	def __init__(self, master, xml=None, heading_text=None,
	             heading_anchor=None, padding=None, cursor=None,
